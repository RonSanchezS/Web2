...
const ArtistaFoto = ({ objeto }) => {
    ...
    const uploadPhoto = () => {
        ...
        axios.post('http://localhost:8080/apiSpotify/?controller=artista&action=photo&id=' + id,
            formData,
            {
                headers: {
    ...
    return (
        <>
            <Card className='mt-3 mb-3'>
                <Card.Body>
                    <Card.Title><h1>Foto de artista con id {id}</h1></Card.Title>
